...
%Content must be of the form: Name, Volume, Weight; ...
...
\addweapon[attack attribute = int, notes = note, base = Longsword, category = Heavy Blades]{Weapon int - str}{2d6}{18-20/x2}{-}{S}{12}{-}
...
%Weapon environment
%Content must be of the form: [optional parameter] Name, Damage, Critical, Range, Weight, Ammo; ...
\begin{Weapon}
