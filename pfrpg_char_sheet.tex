...
\begin{picture}(0,0)
	\put(32,520){\hbox{\includegraphics[scale=0.035]{Images/Logo}}}
\end{picture}


  \put(140,530){\renewcommand{\arraystretch}{1.5}
    \begin{tabular}[b]{D{46} D{23}  D{23}  D{23}  D{23}  D{23}  D{23}  D{23} }
      \multicolumn{3}{D{69}}{\charname} &\multicolumn{3}{D{69}}{ \csname #1charalignment\endcsname} & \multicolumn{2}{D{46}}{\csname #1charplayername\endcsname} \\\cmidrule(rl){1-3}\cmidrule(rl){4-6}\cmidrule(rl){7-8}
