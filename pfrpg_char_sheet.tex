...
\begin{picture}(0,0)
	%\put(25,520){\hbox{\myincludegraphics[scale=0.095]{Images/samurai/Logo.png}}}
\end{picture}
...
%  \put(-0.8,438.5){%
%    \setlength\fboxsep{0pt}\colorbox{black! 35}{%u
%      \makebox(68,80){
%      }%
%    }%
%  }%
  ...
  \stretchattributes{33}{500}{102}{\iftoggle{#1strcountnovaluebool}{-}{\arabic{#1strcount}} ,\plusminus{#1strmodcount},\plusminus{#1strtmpcount},\plusminus{#1strtmpmodcount}}
  %% DEX
  \drawbox[subtext = dexterity]{0}{488}{28}{10}{DEX}
  \stretchattributes{33}{488}{102}{\iftoggle{#1dexcountnovaluebool}{-}{\arabic{#1dexcount}} ,\plusminus{#1dexmodcount},\plusminus{#1dextmpcount},\plusminus{#1dextmpmodcount}}
  
  %% CON
  \drawbox[subtext = constitution]{0}{476}{28}{10}{CON}
  \stretchattributes{33}{476}{102}{\iftoggle{#1concountnovaluebool}{-}{\arabic{#1concount}} ,\plusminus{#1conmodcount},\plusminus{#1contmpcount},\plusminus{#1contmpmodcount}}
  
  %% INT
  \drawbox[subtext = intelligence]{0}{464}{28}{10}{INT}
  \stretchattributes{33}{464}{102}{\iftoggle{#1intcountnovaluebool}{-}{\arabic{#1intcount}} ,\plusminus{#1intmodcount},\plusminus{#1inttmpcount},\plusminus{#1inttmpmodcount}}
  %% WIS
  \drawbox[subtext = wisdom]{0}{452}{28}{10}{WIS}
  \stretchattributes{33}{452}{102}{\iftoggle{#1wiscountnovaluebool}{-}{\arabic{#1wiscount}} ,\plusminus{#1wismodcount},\plusminus{#1wistmpcount},\plusminus{#1wistmpmodcount}}

  %% CHA
  \drawbox[subtext = charisma]{0}{440}{28}{10}{CHA}
  \stretchattributes{33}{440}{102}{\iftoggle{#1chacountnovaluebool}{-}{\arabic{#1chacount}} ,\plusminus{#1chamodcount},\plusminus{#1chatmpcount},\plusminus{#1chatmpmodcount}}
  ...
  \put(177,505){\framebox(28,12){\raggedleft{\csname #1damagereduction\endcsname}}}
...
%%CMB and CMD
  ...
  \stretchequalattributes{25}{310}{131}{\arabic{#1babcount}, \arabic{#1\csname #1cmbmod\endcsname modcount},\arabic{#1specialsizemodcount}, \arabic{#1cmbmisccount}}
  \stretchlabels{25}{304}{131}{TOTAL, BAB,\csname #1cmbmod\endcsname\, mod., size mod., misc}
  \drawbox[family = info, special family = cmd]{0}{289}{21}{11}{cmd}
  \setcounter{tmpcount}{10+\value{#1acmiscbonuscount}+\value{#1acdeflectionbonuscount}}
  \stretchequalattributes{25}{290}{130}{\arabic{#1babcount},\arabic{#1\csname #1cmdstrmod\endcsname modcount},\arabic{#1\csname #1cmddexmod\endcsname modcount},\arabic{#1specialsizemodcount}, \arabic{tmpcount}}
  \stretchlabels{25}{284}{130}{TOTAL, BAB,\csname #1cmdstrmod\endcsname\, mod.,\csname #1cmddexmod\endcsname\, mod., size mod., misc}
%%Speed
  ...
  \put(55,271){\framebox(75,\boxheight){\footnotesize \csname #1charfavouredclass\endcsname}}
